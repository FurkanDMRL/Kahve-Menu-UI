...
class _AnasayfaState extends State<Anasayfa> {
  ...
  var Cappucino = [
    const CoffeeTile(coffeeImagePath: 'assets/images/cappucino.jpg', coffeeNames: 'Cappucino', coffePrice: '4.00'),
  ];
  // ignore: non_constant_identifier_names
  var Latte = [
    const CoffeeTile(coffeeImagePath: 'assets/images/latte.jpg', coffeeNames: 'Latte', coffePrice: '4.00'),
  ];
  // ignore: non_constant_identifier_names
  var Shot = [
    const CoffeeTile(coffeeImagePath: 'assets/images/caffee.jpg', coffeeNames: 'Shot', coffePrice: '4.00'),
  ];
  // ignore: non_constant_identifier_names
  var milk = [
    const CoffeeTile(coffeeImagePath: 'assets/images/milk.jpg', coffeeNames: 'Süt', coffePrice: '4.00'),
  ];
  // ignore: non_constant_identifier_names
  var cay = [
    const CoffeeTile(coffeeImagePath: 'assets/images/tea.jpg', coffeeNames: 'Çay', coffePrice: '2.00'),
  ];
  var yesilcay = [
    const CoffeeTile(coffeeImagePath: 'assets/images/tea.jpg', coffeeNames: 'Yeşil Çay', coffePrice: '3.00'),
  ];
  var all = [
    const CoffeeTile(coffeeImagePath: 'assets/images/cappucino.jpg', coffeeNames: 'Cappucino', coffePrice: '4.00'),
    const CoffeeTile(coffeeImagePath: 'assets/images/latte.jpg', coffeeNames: 'Latte', coffePrice: '4.00'),
